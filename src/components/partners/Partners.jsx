    ...
    <div className="partners">
      <div className="partners-container">
        <div>
          ...
          {partners.first.phone && <p>Тел: {partners.first.phone.map((el, i) => <a key={i} href={`tel:${el}`}>{el}</a>)}</p>}
        </div>
        <div>
          ...
          {partners.second.phone && <p>Тел: {partners.second.phone.map((el, i) => <a key={i} href={`tel:${el}`}>{el}</a>)}</p>}
        </div>
      </div>
    </div>
  )
